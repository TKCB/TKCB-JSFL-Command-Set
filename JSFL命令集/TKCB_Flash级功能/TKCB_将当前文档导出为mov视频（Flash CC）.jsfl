...
{
	var index = fl.getDocumentDOM().name.lastIndexOf( "." );
	var name = fl.getDocumentDOM().name.substring( 0, index );
	fl.getDocumentDOM().exportVideo( folderURI + "/" + name + ".mov", false );
}
