...
for ( i = 0; i < len; i++ )
{
	var myDate = new Date();
	tItem = tItems[ i ];
	if ( tItem.name != "component" && tItem.name != "font" && tItem.name != "picture" && tItem.name != "sound" && tItem.name != "video" && tItem.name != "mc" )
	{
...
{
	tItem = tItems[ i ];
	if ( tItem.name != "component" && tItem.name != "font" && tItem.name != "picture" && tItem.name != "sound" && tItem.name != "video" && tItem.name != "mc" && tItem.itemType != "undefined" )
	{
		strPrefix = "";
